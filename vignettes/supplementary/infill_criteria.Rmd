...
In addition to the most often used _Expected Improvement_, there are also _Confidence Bound_, _Augmented Expected Improvement_, _Expected Quantile Improvement_, _Direct indicator-based Search, the _Mean Response_ and the use of _Standard Error_ implemented.
