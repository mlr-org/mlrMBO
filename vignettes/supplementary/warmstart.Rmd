...
It defaults to `getwd()/mbo_run.RData`.
...
```{r continue_fail}
assign(".counter", 13L, envir = .GlobalEnv) # set counter to not trigger the error
...
You can aces the `opt.state` by calling `load("mlrMBO_run.RData")`.
