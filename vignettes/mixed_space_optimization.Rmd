...
The initial design is set to size of 12:
...
Finally, we start the maximization with `mbo()` with suppressed learner output from *mlr* and we print the result object to obtain the input that lead to the best objective:
```{r mbo_run, eval=TRUE}
