...
# mlrMBO: An in depth introduction
...
## Optimizing a two-dimensional function
...
This tutorial page will provide you with an introduction on how to set the `mbo()` parameters for different kind of optimization scenarios.
...
An important role plays the setting of how the next design points in the sequential loop are chosen. 
...
```{r, eval=TRUE}
mbo(objfun1, design = design1, learner = surr.km, control = ctrl, show.info = FALSE)
```
