...
## 
## $times
##  [1] 0.001 0.000 0.000 0.000 0.001 0.000 0.000 0.000 0.001 0.000 0.000
## [12] 0.000 0.000 0.000 0.001 0.001 0.000 0.000 0.000 0.000
## 
## $resample
## named list()
## 
...
```
## Error: Argumente können nicht durch Wiederverwendung auf gleiche Länge
## gebraucht werden
```
