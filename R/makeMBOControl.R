...
#' @param init.design [\code{data.frame}]\cr
#'   Initial design to be used. \code{data.frame} generated by \code{generateDesign}.
...
makeMBOControl = function(number.of.targets = 1L,
  ...
  init.design.points = 20L, init.design.fun = maximinLHS, init.design.args = list(), init.design = NULL,
